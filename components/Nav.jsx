    ...
    <div className="sm:flex hidden">
        {isUserLoggedIn ? (
            <div className="flex gap-3 md:gap-5">
                ...
                <Link href="/profile">
                <Image src="/assets/images/profile.svg" width={37} height={37} className="rounded-full" 
                alt="profile" />
                </Link>
            ...
            <div className="flex">
                ...
                {toggleDropdown && (
                    <div className="dropdown">
                        ...
                        <Link
                        href="/create-promt" className="dropdown_link" onClick={() => setToggleDropdown (false)}>
                            create
                             prompt
                        </Link>
                      <button 
